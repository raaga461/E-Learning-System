<%-- 
    Document   : swquescon
    Created on : Mar 15, 2013, 5:12:07 PM
    Author     : madhuri
--%>
...
PreparedStatement pstmt1 = null;
 ResultSet rs = null;
                ...
                rs = st.executeQuery("select forumid from swforum where forumid= '" + forumid + "' " );
               ...
               {
                 pstmt1 = con.prepareStatement("insert into swforum values('" + forumid + "','" + question + "','')");
