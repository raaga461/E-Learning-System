...
<br>
<br>
<form name=f1 action="stuhome.jsp" method=post >
    <form name=f2 action="attendance.jsp" method=post >
...
<font color="green" size="2" face="Arial">
    <strong>Login As Student</strong></font></div></td>
</tr>
<tr> 
...
<font size="2" face="Arial, Helvetica, sans-serif">
    <a href="stureg.jsp"><font color="green">SignUp</font></a></font>
