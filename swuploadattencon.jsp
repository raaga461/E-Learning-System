<%-- 
    Document   : swuploadattencon
    Created on : Mar 16, 2013, 8:31:20 AM
    Author     : madhuri
--%>
...
Statement st2=con.createStatement();                
                ...
                if(name.equals(id))
                  ...
                  int i = st1.executeUpdate("update swattendance set totalclasses='"+tc_no+"' where usr= '" + name + "' " );
                  
                  int j = st1.executeUpdate("update swattendance set attendedclasses='"+ac_no+"' where usr= '" + name + "' " );
