<%-- 
    Document   : cnsuploadattencon
    Created on : Mar 16, 2013, 8:29:13 AM
    Author     : madhuri
--%>
...
Statement st2=con.createStatement();                
                ...
                if(name.equals(id))
                  ...
                  int i = st1.executeUpdate("update attendance set totalclasses='"+tc_no+"' where usr= '" + name + "' " );
                  
                  int j = st1.executeUpdate("update attendance set attendedclasses='"+ac_no+"' where usr= '" + name + "' " );
