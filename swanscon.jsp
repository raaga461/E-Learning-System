<%-- 
    Document   : swanscon
    Created on : Mar 15, 2013, 5:00:45 PM
    Author     : madhuri
--%>
...
<%
 ...
 ResultSet rs=st.executeQuery("select * from swforum where forumid='"+forumid+"'");
while(rs.next()){
id=rs.getString(1);
}
 if(forumid.equals(id)){
 Statement st1=con.createStatement();    
int i=st1.executeUpdate("update swforum set answer='"+answer+"' where forumid='"+id+"'");
