<%-- 
    Document   : cnsques
    Created on : Mar 15, 2013, 4:14:55 PM
    Author     : madhuri
--%>
...
<form name="form1" method="post" action="cnsquescon.jsp" id="form1">
<div>
...
{
  System.out.println("It occured an error, which is "+e);
}
%>
...
<table>
    ...
    <TR>
                    <TD></TD>
                    <td style="text-align: center" align=center><INPUT TYPE="submit"value="submit" onClick="validate();"></td>
                </TR>
</table>
<br>
<table align="center">  
