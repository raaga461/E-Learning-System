<%-- 
    Document   : fsw
    Created on : Mar 15, 2013, 4:48:08 PM
    Author     : madhuri
--%>
...
%>
<br><br><br><b><center><font face='bookman old style' color='darkgreen'>SW FORM DETAILS</b></font></center>
<%
while(rs.next())
	{
		%>
...
%>
<center><a href="swans.jsp"><font color="green">post answers</font></a><br><br>
    <a href="swques.jsp"><font color="green">Post New Questions</font></a>
    </center>
 <table align="center">  
