<%-- 
    Document   : fooad
    Created on : Mar 15, 2013, 4:46:33 PM
    Author     : madhuri
--%>
...
%>
<br><br><br><b><center><font face='bookman old style' color='darkgreen'>OOAD FORM DETAILS</b></font></center>
<%
while(rs.next())
	{
		%>
...
%>
<center><a href="ooadans.jsp"><font color="green">post answers</font></a><br><br>
    <a href="ooadques.jsp"><font color="green">Post New Questions</font></a>
    </center>
 <table align="center">  
