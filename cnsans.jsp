<%-- 
    Document   : cnsans
    Created on : Mar 14, 2013, 10:22:09 PM
    Author     : madhuri
--%>
<FORM name=problem METHOD=POST ACTION="http://localhost:8084/elearn/cnsanscon.jsp"></FORM>
...
<script>
    function validate()
    {
        var q=document.getElementById("id_no");
...
<form name="form1" method="post" action="cnsanscon.jsp" id="form1">
<div>
...
<tr>
    ...
    <td style="width:55%" class="tablehead" rowspan="2"><font color="green"><b>Answers</b></font></td><BR>
</tr>
